/**
 * dc.model.Account = Backbone.Model
 * dc.model.AccountSet = Backbone.Collection
...
dc.model.Account = Backbone.Model.extend({
	...
	initialize: function (options) {
		...
		if (this.get('memberships')) {
			this.memberships.reset(this.get('memberships'));
		}
	},
	...
	organization: function () {
		var default_membership = this.memberships.find(function (m) {
	...
	organizations: function () {
		...
		return new dc.model.OrganizationSet(Organizations.filter(function (org) {
			return _.contains(ids, org.get('id'));
		}));
	},
