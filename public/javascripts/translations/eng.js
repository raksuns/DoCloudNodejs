window.I18n.load({
	...
	strings: {
		...
		"added_to_x_documents": ["Added a document to %s", "Added %d documents to %s"],
		"adding_accounts": "Adding Accounts",
		"administrator": "Administrator",
		"all_documents": "All Documents",
		"allow_readers_to_search": "Allow readers to search this set of documents",
		"already_has_account": "%s already has an account.",
		"analyze": "Analyze",
		"analyze_project_in_overview": "Analyze this Project in Overview",
		"analyze_x_docs_in_overview": ["Analyze this Document in Overview", "Analyze these Documents in Overview"],
		"annotated": "Annotated",
		...
		"delete": "Delete",
		"delete_documents": ["Delete Document", "Delete Documents"],
		...
		"disabled": "Disabled",
		"document": "Document",
		"document_access_updated": ["Access updated for the document", "Access updated for %d documents"],
		...
		"document_processing_count": ["There is one documents being processed", "There are %d documents being processed"],
		...
		"documents": "Documents",
		"documents_are_ready": "Your documents are ready",
		...
		"downloading_progress": ["Preparing \"%2$s\" for download...", "Preparing %d documents for download"],
		"draft": "Draft",
		...
		"edit_document_pairs": ["Edit key/value pairs describing this document.", "Edit key/value pairs describing these documents."],
		...
		"enter_url_for_embed": ["Enter the URL at which this document is embedded", "Enter the URL at which these documents are embedded"],
		"enter_url_that_references": ["Enter the URL of the article that references this document", "Enter the URL of the article that references these documents"],
		...
		"invalid_upload_file_type": "\"%s\" has an invalid file type.  We are unable to process documents of this type, please convert the file to a supported document format such as PDF.  \n View %stroubleshooting%s for additional details.",
		"language": "language",
		...
		"make_documents_public": ["Make document public.", "Make %d documents public"],
		"make_public_on": "Make public on",
		"manage": "Manage",
		"manage_account": "Manage Account",
		"manage_organization": "Manage Organization %s",
		"matching_search": "matching this search",
		"max_upload_size_warn": "\"%s\" is more than 400MB in size. Please %soptimize your document%s before continuing.",
		"mentioned_in_x_documents": ["Mentioned in a document", "Mentioned in %d documents"],
		"mentioning_query": "mentioning \u0026ldquo;%s\u0026rdquo;",
		"message": "Message",
		"modification": "modification",
		"modify_original_document": "Modify Original Document",
		"must_have_doc_title": ["Please enter a title for the document", "Please enter a title for all documents."],
		...
		"no_dates_for_timeline": ["We were unable to recognize any dates for %2$s.", "None of the %d documents contained recognizable dates."],
		...
		"no_reviewer_on_document": ["There are no reviewers on this document.", "There are no reviewers on these documents."],
		...
		"password_reset": "DocumentCloud password reset",
		...
		"preview_search_embed_help": "Before continuing, please take a moment to %spreview the document set%s Published documents will open at the URL where they were originally published, while other public documents will open on DocumentCloud.",
		...
		"private_documents_visible_instructions": ["This document is private. You must make it public before it will be visible on your website or in searches of DocumentCloud's catalog. You can choose to make it public at a future date or you can %2$schange it now%3$s.", "These documents are private.  You must make them public before they will be visible on your website or in searches of DocumentCloud's catalog. You can choose to make them public at a future date or you can %2$schange them now%3$s."],
		...
		"really_delete_x_docs": ["Really delete document?", "Really delete %d documents?"],
		"red": "red",
		...
		"redaction_close_while_processing": ["You've redacted a passage. This document will close while it's being rebuilt. Are you sure you're ready to proceed?", "You've redacted %d passages. This document will close while it's being rebuilt. Are you sure you're ready to proceed?"],
		"reenable": "Re-enable",
		...
		"remove_page_warning_message": ["You've selected a page for removal. This document will close while it's being rebuilt. Are you sure you're ready to proceed?", "You've selected %d pages for removal. This document will close while it's being rebuilt. Are you sure you're ready to proceed?"],
		...
		"remove_pages_input": ["Remove Page", "Remove %d Pages"],
		"removed_from_x_documents": ["Removed a document from %s", "Removed %d documents from %s"],
		"removing": "Removing...",
		...
		"review_x_documents": ["Review \"%2$s\" on DocumentCloud", "Review %d documents on DocumentCloud"],
		"reviewer": "Reviewer",
		"reviewer_add_permission_denied": "You are not allowed to add reviewers.",
		"reviewer_email_instructions": ["Email Instructions to %2$s", "Email Instructions to %d Reviewers"],
		...
		"revoke": "Revoke",
		"role_administrator_for_x": "You are an administrator for \n",
		...
		"search_embed_nothing_chosen": "You have not performed a search to embed.  Please either perform a search or select some documents.",
		"search_embed_too_long_error": "Too many documents were selected for embedding.  Please select fewer documents or embed a project",
		...
		"share_x_documents": ["Share this Document", "Share these Documents"],
		"shared_with_you_by": "Shared with you by %s",
		"sharing_x_of_x_documents": "Sharing %d/%d documents",
		"show_all": "Show all",
		"show_all_x_pages": ["Show single page", "Show all %d pages"],
		"show_less": "Show less",
		"show_more": "Show more",
		...
		"uploaded_x_document_has": ["the uploaded document has", "the %d uploaded documents have"],
		"uploaded_x_documents": ["Uploaded one Document", "Uploaded %d Documents"],
		"uploading": "Uploading",
		...
		"welcome_to_document_cloud": "Welcome to DocumentCloud",
		"width": "Width",
		"workspace": "Workspace",
		"x_accounts": ["%d account", "%d accounts"],
		"x_collaborators": ["One Collaborator", "%d Collaborators"],
		"x_documents": ["%d Document", "%d Documents"],
		"x_has_documents": "%s Documents",
		"x_invited_to_review_x": "%s has invited you to review %s",
		"x_is_no_longer_a_reviewer_on_x": ["%2$s is no longer a reviewer on the Document", "%2$s is no longer a reviewer on the %1$d Documents"],
		"x_is_not_published": "\"%s\" is not published.",
		"x_mentions": ["One Mention", "%d Mentions"],
		"x_notes": ["%d Note", "%d Notes"],
		"x_pages": ["%d Page", "%d Pages"],
		"x_private_documents": ["%d Private Document", "%d Private Documents"],
		"x_public_documents": ["%d Public Document", "%d Public Documents"],
		"x_results": ["%d Result", "%d Results"],
		...
		"youve_been_added_to_x": "You have been added to %s",
		"zoom_out": "Zoom Out"
	}
