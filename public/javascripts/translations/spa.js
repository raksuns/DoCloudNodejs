window.I18n.load({
	...
	strings: {
		...
		"added_to_x_documents": ["Se agregó un documento a %s", "Se agregaron %d documentos a %s"],
		...
		"delete": "Borrar",
		"delete_documents": ["Borrar Documento", "Borrar Documentos"],
		"deleting_documents": "Eliminación de documentos ... ",
		...
		"document": "Documento",
		"document_access_updated": ["Acceso actualizado para este documento", "Acceso actualizado para %d documentos"],
		...
		"document_processing_count": ["Se está procesando un documento", "Se están procesando %d documentos"],
		...
		"documents_are_ready": "Sus documentos están listos",
		...
		"downloading_progress": ["Preparación de \"%2$s\" para descargar ...", "Preparación %d documentos para descargar"],
		"draft": "Borrador",
		...
		"edit_document_pairs": ["Editar parejas de clave/valor que describen a este documento.", "Editar parejas de clave/valor que describen a estos documentos."],
		...
		"enter_url_for_embed": ["Proveer URL donde este documento está incrustado", "Proveer URL donde estos documentos están incrustados"],
		"enter_url_that_references": ["Provee el URL del artículo que se refiere a este documento.", "Provee el URL del artículo que se refiere a estos documentos."],
		...
		"for_example_data": "Por ejemplo: \u0026ldquo;birth: 1935-01-08\u0026rdquo;, or \u0026ldquo;status: released\u0026rdquo;",
		"force_ocr": "Forzar OCR",
		"form_contact_instructions": "Utiliza este formulario (o mándanos un email a %s) para solicitar asistencia. Si necesitas hablar con alguien inmediatamente, llama al (202) 505-1010. Visita %s para otras formas de ponerte en contacto con nosotros.",
		...
		"mentioned_in_x_documents": ["Mencionada en un documento", "Mencionada en %d documentos"],
		"mentioning_query": "mentioning \u0026ldquo;%s\u0026rdquo;",
		"message": "Mensaje",
		"modification": "modificación",
		"modify_original_document": "Modificar el Documento Original",
		"must_have_doc_title": ["Por favor provee un título pare este documento", "Por favor provee un título pare estos documentos documents."],
		...
		"no_dates_for_timeline": ["Fuimos incapaces de reconocer cualquier fecha para %2$s. ", "Ninguno de los documentos %d contenía fechas reconocibles. "],
		...
		"no_results_for": "No hay resultados para %s ",
		"no_reviewer_on_document": ["No hay revisores en este documento.", "No hay revisores en estos documentos."],
		...
		"note": ["Nota", "Notas"],
		"note_ellipsis": "Nota ...",
		"note_embed_private": "Este documento es privado: notas en este documento no se podrán ver hasta que sea público.  Cambiar el %snivel de acceso%s ahora o",
		...
		"organization": ["Organizaciones", "Organizaciones "],
		...
		"password_reset": "Restablecimiento de contraseña DocumentCloud",
		...
		"publish": "Publicar",
		"publish_choose_display": "Elije si quieres ofrecer tu documento de %spágina completa%s o si quieres %suna caja de tamaño específico%s.",
		"published": "Publicado ",
		...
		"really_delete_x_docs": ["¿Seguro que quieres borrar este documento?", "¿Seguro que quieres borrar estos documentos?"],
		"red": "rojo",
		...
		"remove_pages_input": ["Retire página", "Quite %d Páginas"],
		"removed_from_x_documents": ["Se eliminó un documento de %s", "Se eliminaron %d documentos de %s"],
		...
		"review_x_documents": ["Crítica \"%2$s\" en DocumentCloud", "Revise %d documentos en DocumentCloud"],
		"reviewer": "Revisor",
		"reviewer_add_permission_denied": "No se permite añadir colaboradores.",
		"reviewer_email_instructions": ["Las instrucciones por correo electrónico a %2$s", "Las instrucciones por correo electrónico a %d revisores"],
		...
		"revoke": "Revocar",
		"role_administrator_for_x": "Usted es un administrador para %s ",
		"role_contributor_for_x": "Usted es un contribuyente para %s",
		"role_freelancer_for_x": "Usted es un profesional independiente para %s",
		"role_reviewer_for_x": "Usted es un revisor para %s",
		"save": "Guardar",
		...
		"share_x_documents": ["Compartir este Documento", "Compartir estos Documentos"],
		"shared_with_you_by": "Compartido por ti %s",
		"show_all": "Mostrar todas",
		"show_all_x_pages": ["Mostrar una página", "Mostrar todas las %d páginas"],
		...
		"uploaded_x_document_has": ["el documento subido tiene", "los %d documentos tienen"],
		"uploaded_x_documents": ["Un Documunto subido", "%d Documentos subidos"],
		"uploading": "Subiendo",
		...
		"welcome_to_document_cloud": "Bienvenido a DocumentCloud ",
		"width": "Anchura",
		"workspace": "Área de trabajo",
		"x_accounts": ["%d cuenta ", "%d cuentas"],
		"x_collaborators": ["Un Colaborador", "%d Colaboradores"],
		"x_documents": ["%d Documento", "%d Documentos"],
		"x_has_documents": "%s Documentos",
		"x_invited_to_review_x": "%s te ha invitado a revisar %s",
		"x_is_no_longer_a_reviewer_on_x": ["%2$s ya no es un crítico en el documento", "%2$s ya no es un crítico de los %1$d Documentos"],
		"x_is_not_published": "\"%s\" no se publica.",
		"x_mentions": ["Una Mención", "%d Menciones"],
		"x_notes": ["Una Nota", "%d Notas"],
		"x_pages": ["Una Página", "%d Páginas"],
		"x_private_documents": ["%d Documento Privado", "%d Documentos Privados"],
		"x_public_documents": ["%d Documento Público", "%d Documentos Públicos"],
		"x_results": ["%d Resultado ", "%d Resultados"],
		...
		"youve_been_added_to_x": "Usted se han añadido a la cuenta %s",
		"zoom_out": "Alejar"
	}
